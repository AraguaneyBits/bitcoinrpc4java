...
import com.araguaneybits.crypto.bitcoinrpc.methods.response.BtcRpcBlockchainInfoResponse;
...
public class BtcRpcBlockchainMethods extends BaseBtcRpcMethods {
     ...
     * </pre>
     */
    public BtcRpcBlockchainInfoResponse getBlockchainInfo() {
        String json = callSimpleRpcMethod(RpcBlockchainMethodsConstants.BLOCKCHAIN_GET_BLOCKCHAIN_INFO);

        RpcOutputMessage rpcOutputMessage = (RpcOutputMessage) TransformBeanUtils.readValue(json,
                new TypeReference<RpcOutputMessage<BtcRpcBlockchainInfoResponse>>() {
                });

        return (BtcRpcBlockchainInfoResponse) rpcOutputMessage.getResult();
    }
    ...
    public Object getBlockCount() {
        return callRpcMethod(RpcBlockchainMethodsConstants.BLOCKCHAIN_GET_BLOCK_COUNT);
    }
     ...
     * </pre>
     */
    public Object getBlockHash(Long height) {
        return callRpcMethod(RpcBlockchainMethodsConstants.BLOCKCHAIN_GET_BLOCK_HASH, height);
    }
     ...
     * </pre>
     */
    public Object getBlockHeader(String hash, Boolean verbose) {
        return callRpcMethod(RpcBlockchainMethodsConstants.BLOCKCHAIN_GET_BLOCK_HEADER, hash, verbose);
    }
     ...
     * </pre>
     */
    public Object getBlockStats() {
        return callRpcMethod(RpcBlockchainMethodsConstants.BLOCKCHAIN_GET_BLOCK_STATS);
    }
     ...
     * </pre>
     */
    public Object getMempoolAncestors() {
        return callRpcMethod(RpcBlockchainMethodsConstants.BLOCKCHAIN_GET_MEMPOOL_ANCESTORS);
    }
